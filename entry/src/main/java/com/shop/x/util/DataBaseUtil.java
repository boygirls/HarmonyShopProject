...
import com.shop.x.user.model.User;
...
public class DataBaseUtil {
    ...
    private static Uri uri1 = Uri.parse("dataability:///com.shop.x.MallDataAbility/mall_info");
    private static Uri uri2 = Uri.parse("dataability:///com.shop.x.MallDataAbility/user");
    private static Uri uri3 = Uri.parse("dataability:///com.shop.x.MallDataAbility/ShopCart");
